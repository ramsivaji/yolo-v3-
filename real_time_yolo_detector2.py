...
# Load Yolo
net = cv2.dnn.readNet(
    r"D:\vs code files\YOLO-Real-Time-Object-Detection\weight\yolov3-tiny.weights",
    r"D:\vs code files\YOLO-Real-Time-Object-Detection\cfg\yolov3-tiny.cfg"
)

# Load the file which we want dectct
classes = []
with open(r"D:\vs code files\YOLO-Real-Time-Object-Detection\coco.names", "r") as f:
    classes = [line.strip() for line in f.readlines()]

# Get the YOLO network layer names
layer_names = net.getLayerNames()
output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers().flatten()]
colors = np.random.uniform(0, 255, size=(len(classes), 3))

# Loading video file
cap = cv2.VideoCapture(r"D:\vs code files\YOLO-Real-Time-Object-Detection\check2.mp4")
